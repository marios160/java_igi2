...
public class IGI2Bugs {
    ...
    public static void main(String[] args) {
        try {
            ...
            ip = "89.66.97.216";//args[0];
            port = 26001;//Integer.parseInt(args[1]);
...
//                String nick = "616161616161616161616161616161616161616161616161616161616161616161616161616161616161616161616161616161616161616161616161616161616161";
//                cmd = cmd.concat(nick);
...
//                pck3[32] = odp[24];   // w tym wypadku trzeba bylo odjac 1 od wartosci
//                pck3[33] = (byte) z1;
//                pck3[34] = odp[26];
//                pck3[35] = odp[27];
...
//            }
    ...
    static public byte[] sendPck(String str) {
        ...
        try {
            ...
            System.out.println("2 pakiet "+ ex);
            return null;
        }
    ...
    static public String sendHexPck(byte[] msg) {
        ...
        try {
            ...
            System.out.println("3 pakiet".toString() + ex);
        }
        return message;
    }

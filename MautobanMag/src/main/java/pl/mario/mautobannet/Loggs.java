...
public class Loggs {
    ...
    public static void loguj(String fun, Exception message)
    {
        ...
        try {
            ...
            log.append(zakoduj(AutoBan.time()+fun.toUpperCase()+": "+message.getMessage()+"\n"+mes)+"\n\n");
            log.close();
        } catch (FileNotFoundException ex) {
        ...
        System.out.println(AutoBan.time()+fun.toUpperCase()+": "+message.getMessage()+"\n"+mes);
        
    }
    public static void loguj(String fun, Error message)
    {
        String mes = "";
        for (StackTraceElement stack : message.getStackTrace()) {
            mes+=stack.toString()+"\n";
    ...
    public static void loguj(String fun, Throwable message)
    {
        String mes = "";
        for (StackTraceElement stack : message.getStackTrace()) {
            mes+=stack.toString()+"\n";
    ...
    public static void loguj(String fun, Exception message, String msg)
    {
        ...
        try {
            PrintWriter log = new PrintWriter(new FileWriter("MautobanExceptions.log",true));
            log.append(zakoduj(AutoBan.time()+fun.toUpperCase()+": "+message.getMessage()+"\n"+mes+"\n"+msg)+"\n\n");
            log.close();
        } catch (FileNotFoundException ex) {
            JOptionPane.showMessageDialog(null, "Loguj: "+ex);
